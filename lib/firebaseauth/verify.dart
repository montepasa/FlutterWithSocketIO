...
import 'package:oops/screen/Login/login.dart';
import 'package:oops/utils/constants.dart';
import 'package:oops/utils/widgets.dart';
...
//    _showSnackBar(phoneAuthDataProvider.message);
  ...
  onVerified() async {
   ...
   FirebaseUser user = await Provider.of<PhoneAuthDataProvider>(context, listen: false).getCurrentUser();
    Navigator.of(context)
        .push(MaterialPageRoute(builder: (BuildContext context) => Login(user : user)));
  }
